...
(cl:defclass <EventArray> (roslisp-msg-protocol:ros-message)
  ((header
   ...
   (events
    :reader events
    :initarg :events
    :type (cl:vector event_msgs-msg:Event)
   :initform (cl:make-array 0 :element-type 'event_msgs-msg:Event :initial-element (cl:make-instance 'event_msgs-msg:Event))))
)
...
(cl:defmethod cl:initialize-instance :after ((m <EventArray>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'EventArray)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name event_msgs-msg:<EventArray> is deprecated: use event_msgs-msg:EventArray instead.")))

(cl:ensure-generic-function 'header-val :lambda-list '(m))
(cl:defmethod header-val ((m <EventArray>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader event_msgs-msg:header-val is deprecated.  Use event_msgs-msg:header instead.")
  (header m))

(cl:ensure-generic-function 'height-val :lambda-list '(m))
(cl:defmethod height-val ((m <EventArray>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader event_msgs-msg:height-val is deprecated.  Use event_msgs-msg:height instead.")
  (height m))

(cl:ensure-generic-function 'width-val :lambda-list '(m))
(cl:defmethod width-val ((m <EventArray>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader event_msgs-msg:width-val is deprecated.  Use event_msgs-msg:width instead.")
  (width m))

(cl:ensure-generic-function 'events-val :lambda-list '(m))
(cl:defmethod events-val ((m <EventArray>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader event_msgs-msg:events-val is deprecated.  Use event_msgs-msg:events instead.")
  (events m))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <EventArray>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'events)))
    ...
    (cl:setf (cl:aref vals i) (cl:make-instance 'event_msgs-msg:Event))
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<EventArray>)))
  ...
  (cl:format cl:nil "# This message contains an array of events~%# (0, 0) is at top-left corner of image~%#~%~%Header header~%~%uint32 height         # image height, that is, number of rows~%uint32 width          # image width, that is, number of columns~%~%# an array of events~%Event[] events~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%string frame_id~%~%================================================================================~%MSG: event_msgs/Event~%# A DVS event~%uint16 x~%uint16 y~%time ts~%bool polarity~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'EventArray)))
  "Returns full string definition for message of type 'EventArray"
  (cl:format cl:nil "# This message contains an array of events~%# (0, 0) is at top-left corner of image~%#~%~%Header header~%~%uint32 height         # image height, that is, number of rows~%uint32 width          # image width, that is, number of columns~%~%# an array of events~%Event[] events~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%string frame_id~%~%================================================================================~%MSG: event_msgs/Event~%# A DVS event~%uint16 x~%uint16 y~%time ts~%bool polarity~%~%~%"))
